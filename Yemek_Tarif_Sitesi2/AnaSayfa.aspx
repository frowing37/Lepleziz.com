<%@ Page Title="" Language="C#" MasterPageFile="~/Kullanıcı.Master" AutoEventWireup="true" CodeBehind="AnaSayfa.aspx.cs" Inherits="Yemek_Tarif_Sitesi2.AnaSayfa" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder" runat="server">
    <asp:DataList ID="DataList2" runat="server">
        <ItemTemplate>
            <table class="auto-style6">
                <tr>
                    <td colspan="2" style="background-color: #CC00CC">
                    <a href="YemekDetay.aspx?yemekid=<%# Eval("YemekID") %>"> <asp:Label ID="Label3" runat="server" ForeColor="White" style="font-size: xx-large; text-decoration: underline" Text='<%# Eval("YemekAd") %>'></asp:Label> </a>
                    </td>
                </tr>
                <tr>
